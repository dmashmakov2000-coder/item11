--[[
    ...
    Изменения:
    1. ИСПРАВЛЕНА ОШИБКА "attempt to call field 'RadioButton' (a nil value)":
       В mimgui функция RadioButton отсутствует. Заменена на стилизованные интерактивные кнопки с подсветкой активного периода (7д, 14д, 30д).
    2. Исправлены все спецсимволы HTML (&gt; и &lt;), из-за которых логика условий в скрипте могла нарушаться.
    3. Полностью сохранены все существующие функции: логотип, Telegram-уведомления, визуальный график доходов (ImDrawList), статистика, PayDay, квесты и BTC.
]]
